...
const Card: NextPage<CardProps> = (props) => {
  return (
    <Link href={props.id}>
      <a className="translate-y-0 hover:-translate-y-2 transition-transform">
        <div className="shadow-lg hover:shadow-xl rounded-lg md:max-w-sm w-full m-auto transition">
          <img
            alt="test"
            src={props.imageSrc}
